...
| --- | --- |
| 运行状态 | `failure` |
| 上次运行时间 | 2026-06-22 16:40:26 北京时间 |
| 耗时 | 27分03秒 |
| 触发方式 | `schedule` |
...
| 最终情报库 | 总数 1565，新增 0 |
| 告警建议集 | 总数 355 |
| 源抓取状态 | 成功 2854，失败 349，使用缓存 0 |
| 运行链接 | [GitHub Actions](https://github.com/AdamYoung71/mining-pool-domain-intel/actions/runs/27940320109) |
<!-- intel-status:end -->
